...
BOT_USERNAME = "BidforWorkBot"  # 🔥 Apne bot ka username (bin @ ke) daalo
...
def main():
    ...
    # JobQueue (Background Price Drop) - APScheduler install hona chahiye
...
if __name__ == "__main__":
    # 🔥 Render Web Service ke liye port bind karo (Background thread mein)
    ...
    # Bot shuru karo (yeh blocking hai, web server background mein chalta rahega)
    main()
